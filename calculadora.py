...
b1.grid(row=0, column=0, padx=12,pady=25)

b2=Button(ventana, text="2")
b2.grid(row=0, column=1, padx=12,pady=25)

b3=Button(ventana, text="3")
b3.grid(row=0, column=2, padx=12,pady=25)
...
b7.grid(row=2, column=0, padx=12,pady=25)

b8=Button(ventana, text="8")
b8.grid(row=2, column=1, padx=12,pady=25)

b9=Button(ventana, text="9")
b9.grid(row=2, column=2, padx=12,pady=25)
